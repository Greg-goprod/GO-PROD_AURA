...
/**
 * Modal AURA d̩pla̤able
 * Permet de d̩placer le modal en cliquant et glissant sur le header
 */
export const DraggableModal: React.FC<DraggableModalProps> = ({
  ...
  // R̩initialiser la position quand le modal s'ouvre
  useEffect(() => {
    if (open) {
      setPosition({ x: 0, y: 0 });
    }
  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    // Limiter le d̩placement pour que le modal reste visible
